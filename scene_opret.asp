...
<%
	...
	if Request("Action") = "Opret" then
		...
		rs("KapitelID") = Session.Contents("kapitelid")
		...
		'### Find antallet af scener i kapitlet
		strSQL = "SELECT count(*) AS SceneAntal from tbScene WHERE KapitelID = " & Session.Contents("kapitelid") & " "
...
<div class="w3-grid" style="grid-template-columns:20% 60% 20%">
	...
	<div class="w3-padding">
		<h2>Opret en ny scene.</h2>
		<p>Her kan du oprette en ny scene i kapitlet.</p>
...
%>
			...
			<button type="submit" class="w3-button w3-green w3-quarter" name="Action" value="Opret">Opret scene</button>
